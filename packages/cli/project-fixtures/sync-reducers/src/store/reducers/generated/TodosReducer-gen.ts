...
// this file is auto generated on 2020-03-31T13:11:08.277Z, don't modify it
...
export type TodosReducerAction = { name: "createTodo", group: "TodosReducer", payload: string } | { name: "markFirstTodoComplete", group: "markFirstTodoComplete" } | { name: "deleteTodoAtIndex", group: "TodosReducer", payload: number } | { name: "chnageSecondTodoOnly", group: "TodosReducer", payload: number } | { name: "markAllOfThemAsCompleted", group: "TodosReducer", payload: number[] }
...
export const TodosReducerReducerGroup: ReducerGroup<TodosReducerState, TodosReducerAction, "TodosReducer", TodosReducerAsyncAction> = {
    r:
        (state: TodosReducerState, action: TodosReducerAction) => {
            ...
            switch (t) {
                case "createTodo": {
                    const text1 = (action as any).payload as (string)
                ...
                case "markAllOfThemAsCompleted": {
                    const indexes = (action as any).payload as (number[])
                    let _tr_list = [...state.list]
