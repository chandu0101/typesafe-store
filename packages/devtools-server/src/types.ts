...
export type ConnectionInitialteMessage = { kind: "InitiateConnection", type: "App" | "DevTools", appName?: string }
...
export type StateMessage = { kind: "State", state: string, id: String, appName: string }
