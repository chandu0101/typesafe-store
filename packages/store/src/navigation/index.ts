...
export type NavigationAction = { name: "setLocation", group: typeof NAVIGATION_REDUCER_GROUP_NAME, payload: Location }

export const NavigationReducerGroup: ReducerGroup<NavigationState, NavigationAction, typeof NAVIGATION_REDUCER_GROUP_NAME, undefined> = {
