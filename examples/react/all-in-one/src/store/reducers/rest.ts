...
class RestReducer {
    ...
    createTodo: testApiTypes.requests.CreateTodo & AppendToList<RestReducer["todos"]["data"]> = {}

    updateTodo: testApiTypes.requests.UpdateTodo & UpdateList<RestReducer["todos"]["data"]> = {}

    deleteTodo: testApiTypes.requests.DeleteTodo & DeleteFromList<RestReducer["todos"]["data"]> = {}
